...
public class Map3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        FlyerRaider raider1 = new FlyerRaider();
        ShieldRaider raider2 = new ShieldRaider();
        WizardRaider raider3 = new WizardRaider();
        FlyerRaider raider4 = new FlyerRaider();
        SpeedyRaider raider5 = new SpeedyRaider();
        FlyerRaider raider6 = new FlyerRaider();
        SpeedyRaider raider7 = new SpeedyRaider();
        WizardRaider raider8 = new WizardRaider();
