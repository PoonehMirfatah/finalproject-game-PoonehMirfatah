...
public class Map4Controller implements Initializable {
        ...
        public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            towersPosition.add(p7);

            ArrayList<Wave> attackWaves = new ArrayList<>();
            SpeedyRaider raider1 = new SpeedyRaider();
            FlyerRaider raider2 = new FlyerRaider();
            WizardRaider raider3 = new WizardRaider();
            FlyerRaider raider4 = new FlyerRaider();
            SpeedyRaider raider5 = new SpeedyRaider();
            ShieldRaider raider6 = new ShieldRaider();
            WizardRaider raider7 = new WizardRaider();
            FlyerRaider raider8 = new FlyerRaider();
            SpeedyRaider raider9 = new SpeedyRaider();
            ShieldRaider raider10 = new ShieldRaider();
            WizardRaider raider11 = new WizardRaider();
            FlyerRaider raider12 = new FlyerRaider();
            SpeedyRaider raider13 = new SpeedyRaider();
            FlyerRaider raider14 = new FlyerRaider();
            ShieldRaider raider15 = new ShieldRaider();

            Wave wave1 = new Wave(raider1, 3);
            Wave wave2 = new Wave(raider2, 4);
            Wave wave3 = new Wave(raider3, 6);
            Wave wave4 = new Wave(raider4, 8);
            Wave wave5 = new Wave(raider5, 8);
            Wave wave6 = new Wave(raider6, 8);
            Wave wave7 = new Wave(raider7, 10);
            Wave wave8 = new Wave(raider8, 10);
            Wave wave9 = new Wave(raider9, 10);
            Wave wave10 = new Wave(raider10, 10);
            Wave wave11 = new Wave(raider11, 12);
            Wave wave12 = new Wave(raider12, 12);
            Wave wave13 = new Wave(raider13, 12);
            Wave wave14 = new Wave(raider14, 12);
            Wave wave15 = new Wave(raider15, 14);
            ...
            attackWaves.add(wave11);
            attackWaves.add(wave12);
            attackWaves.add(wave13);
            attackWaves.add(wave14);
            attackWaves.add(wave15);
    ...
    public void removeRaider(Raider currentRaider,VBox vBox,PathTransition pathTransition) {
        ...
        public void setPath() {
            ...
            double xStart2 = ps2.getStartX() + ps2.getLayoutX();
            double yStart2 = ps2.getStartY() + ps2.getLayoutY();
            ...
            double xControl21 = ps2.getControlX() + ps2.getLayoutX();
            double yControl21 = ps2.getControlY() + ps2.getLayoutY();

            double xEnd1 = ps1.getEndX() + ps1.getLayoutX();
            double yEnd1 = ps1.getEndY() + ps1.getLayoutY();

            double xEnd21 = ps2.getEndX() + ps2.getLayoutX();
            double yEnd21 = ps2.getEndY() + ps2.getLayoutY();

            double xControl2 = ps3.getControlX() + ps3.getLayoutX();
            double yControl2 = ps3.getControlY() + ps3.getLayoutY();
            double xEnd2 = ps3.getEndX() + ps3.getLayoutX();
            double yEnd2 = ps3.getEndY() + ps3.getLayoutY();
            double xControl3 = ps4.getControlX() + ps4.getLayoutX();
            double yControl3 = ps4.getControlY() + ps4.getLayoutY();
            double xEnd3 = ps4.getEndX() + ps4.getLayoutX();
            double yEnd3 = ps4.getEndY() + ps4.getLayoutY();
            double xControl4 = ps5.getControlX() + ps5.getLayoutX();
            double yControl4 = ps5.getControlY() + ps5.getLayoutY();
            double xEnd4 = ps5.getEndX() + ps5.getLayoutX();
            double yEnd4 = ps5.getEndY() + ps5.getLayoutY();
            ...
            path2.getElements().add(new QuadCurveTo(xControl21, yControl21, xEnd21, yEnd21));
            path2.getElements().add(new QuadCurveTo(xControl2, yControl2, xEnd2, yEnd2));
            path2.getElements().add(new QuadCurveTo(xControl3, yControl3, xEnd3, yEnd3));
